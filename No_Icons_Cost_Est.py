...
watermark_img = Image.open("assets/b.jpg")
...
<div class="main-header">
    <div class="main-title">◆ Snowflake Cost Estimator</div>
...
if additional_discount > 0:
    optimizations.append(f"◦ Usage optimization unlocks {additional_discount}% additional discount")
...
if savings_pct > 0:
    ...
    if pause_hours_per_day > 0:
        st.info(f"◐ **Quick Win**: Auto-pause configuration can be implemented immediately for {pause_hours_per_day}h daily savings")
